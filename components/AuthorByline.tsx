  ...
  return (
    <div dir="rtl" className="card p-6 mt-6">
      ...
      <p className="text-gray-700 leading-relaxed mb-3">
        ...
        {' '}בתחום שכפול, שחזור וקידוד מפתחות לרכב. אמיר הקים את מפתח עכשיו מתוך התמחות צרה וברורה -
      ...
      <p className="text-gray-700 leading-relaxed">
        הניסיון הרב של אמיר מאפשר לנו לטפל בכל סוגי המפתחות - ממפתחות מכניים ישנים ועד מערכות Smart Key

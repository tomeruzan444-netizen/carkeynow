...
const CITIES_KEY: NavItem[] = [
  { label: 'שכפול מפתח בקריית מוצקין', href: '/שכפול-מפתח-לרכב-בקריית-מוצקין' },
  { label: 'שכפול מפתח בטירת הכרמל', href: '/שכפול-מפתח-לרכב-בטירת-הכרמל' },
  { label: 'שכפול מפתח בגני תקווה',   href: '/שכפול-מפתח-לרכב-בגני-תקווה' },
  ...
  { label: 'שכפול מפתח בקריית אתא',  href: '/שכפול-מפתח-לרכב-בקריית-אתא' },
  { label: 'שכפול מפתח בקריית ביאליק', href: '/שכפול-מפתח-לרכב-בקריית-ביאליק' },
  { label: 'שכפול מפתח בפרדס חנה כרכור', href: '/שכפול-מפתח-לרכב-בפרדס-חנה-כרכור' },
  { label: 'שכפול מפתח בבית שמש',     href: '/שכפול-מפתח-לרכב-בבית-שמש' },
];

const BRANDS: NavItem[] = [
  { label: 'שכפול מפתחות לסקייוול', href: '/שכפול-מפתח-לסקייוול' },
...
const KODAN_CITIES: NavItem[] = [
  { label: 'קודן לרכב ביבנה', href: '/קודן-לרכב-ביבנה' },
  ...
  { label: 'קודן לרכב בראש העין',  href: '/קודן-לרכב-בראש-העין' },
  { label: 'קודן לרכב בקרית אונו', href: '/קודן-לרכב-בקרית-אונו' },
];

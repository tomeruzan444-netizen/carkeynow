...
export const kmOwnerCards: FeatCard[] = [
  { title: 'הרישיון בתוך הרכב', desc: 'פותחים בלי נזק, מוציאים את הרישיון ומצליבים מול תעודה מזהה. רק אז מייצרים.' },
  { title: 'הרישיון לא נמצא כלל', desc: 'קוראים מספר שלדה מבסיס השמשה ומצליבים מול הרישום ומול תעודה מזהה.' },
  { title: 'הבעלים לא יכול להגיע', desc: 'ייפוי כוח בכתב עם צילום תעודה מזהה, ואימות טלפוני מול הבעלים לפני שמתחילים.' },
  { title: 'רכב חברה או ליסינג', desc: 'אישור בכתב מהגורם המורשה, לצד רישיון הרכב ותעודה מזהה של הנהג.' },
  { title: 'כשאף אחד לא מתקיים', desc: 'לא מבצעים את העבודה. עדיף לוותר על קריאה מאשר לייצר מפתח למי שלא ידוע.' },
  { title: 'למה זה לפני ולא אחרי', desc: 'סדר הפעולות הזה הוא מה שמפריד בין שירות מנעולנות לבין סיוע לגניבה.' },
];

export const kmProcess: Step[] = [
  { title: 'בירור בטלפון', desc: 'יצרן, שנה, האם יש מפתח שעובד, והאם הרכב נעול והמסמכים בתוכו. השאלה האחרונה קובעת עם מה נגיע.', duration: '3 דק׳' },
  { title: 'פתיחה בלי נזק', desc: 'כלים ייעודיים דרך מנגנון הנעילה או מרווח הדלת. בשלב הזה לא נוגעים במערכת החשמל.', duration: '5-20 דק׳' },
  { title: 'אימות בעלות', desc: 'רישיון מול תעודה מזהה, ואם הרישיון חסר, מספר שלדה מבסיס השמשה מול הרישום.', duration: '5 דק׳' },
  { title: 'בדיקת מתח והערת המערכת', desc: 'מייצב מתח לפני התכנות, והערת יחידת הבקרה ברכב שעמד ימים ונכנס לחיסכון עמוק.', duration: '5-10 דק׳' },
  { title: 'ייצור, קידוד ומחיקה', desc: 'חותכים, מקודדים, ומוחקים את המפתח שאבד כדי שלא יתניע אם יימצא.', duration: '25-60 דק׳' },
];
...
export const gtEraseCards: FeatCard[] = [
  { title: 'המפתח אבד בתוך הבית', desc: 'הוא לא בידיים זרות. מוסיפים מפתח בלי למחוק, והישן ימשיך לעבוד אם יימצא.' },
  { title: 'המפתח נשמט בחוץ', desc: 'ברחוב או בחניון, ובמיוחד אם היה עליו מסמך עם כתובת. כאן מחיקה מלאה מוצדקת.' },
  { title: 'נשאר מפתח שעובד', desc: 'רק במצב הזה הבחירה בכלל קיימת. אפשר להוסיף מפתח בלי לגעת בקיימים.' },
  { title: 'לא נשאר אף מפתח', desc: 'ברוב הדגמים התכנות מחייב ממילא מחיקה של כל המפתחות הרשומים.' },
  { title: 'כמה עולה המחיקה', desc: '100-250 שקל, סעיף נפרד בחשבון שאפשר לוותר עליו כשהוא לא נחוץ.' },
  { title: 'למה זה השלב האחרון', desc: 'מוחקים בסוף ולא בהתחלה, כדי שאפשר יהיה לעצור אם המפתח נמצא באמצע.' },
];

export const gtProcess: Step[] = [
  { title: 'שלוש שאלות בטלפון', desc: 'יצרן ודגם, שנת ייצור, והאם יש כרגע מפתח שעובד. השאלה השלישית היא זו שקובעת את המחיר.', duration: '3 דק׳' },
  { title: 'שער, חניה ותאורה', desc: 'שואלים אם הרכב מאחורי שער חשמלי, אם אפשר לפתוח את דלת הנהג עד הסוף, ואם החצר מוארת בערב.', duration: '2 דק׳' },
  { title: 'זיהוי המערכת בהגעה', desc: 'קוראים את מערכת האימובילייזר של הדגם ומוודאים שהבלנק שבניידת הוא הנכון לפני שחותכים.', duration: '10 דק׳' },
  { title: 'חיתוך וקידוד', desc: 'חותכים לפי קוד היצרן ומקודדים מול הרכב. מפתח חכם דורש תהליך ארוך יותר ממפתח עם שבב.', duration: '20-60 דק׳' },
  { title: 'מחיקה רק אם צריך', desc: 'שלב נפרד ואחרון. עוצרים לפניו, מוודאים איתכם שזה מה שאתם רוצים, ורק אז מוחקים.', duration: '10-20 דק׳' },
];
...
// ─── KODAN · ROSH HAAYIN (רכב עבודה, שלושה אזורי הגנה) ───────────────

export const rhaZoneCards: FeatCard[] = [
  { title: "תא הנהג", desc: "מתגי דלתות, חיישן נפח והגנה על ההתנעה. זה מה שכל מערכת בסיסית מכסה." },
  { title: "תא המטען", desc: "מופרד במחיצה אטומה. חיישן מתא הנהג אינו רואה לשם, ונדרש חיישן שני." },
  { title: "דלת ההזזה בצד", desc: "מרווח גדול יותר מדלת רגילה, ובהתקנות רבות המתג שלה לא חובר בכלל." },
  { title: "הדלתות האחוריות", desc: "הדרך המהירה להוציא ציוד, ולכן המועדפת. הצירים לעיתים חיצוניים." },
  { title: "ארגזים חיצוניים", desc: "ארגז גג, ארגז צד או סולם. לא מחוברים למערכת בלי מתג ייעודי." },
  { title: "סירנה עם גיבוי", desc: "סוללה עצמאית שממשיכה לעבוד גם אם נותק המצבר. קריטי בחניית רחוב." },
];

export const rhaProcess: Step[] = [
  { title: "בדיקת מה כבר מותקן", desc: "פותחים ובודקים אילו מתגים מחוברים ומה חיישן הנפח באמת מכסה. כאן מתגלה רוב הפער.", duration: "15 דק׳" },
  { title: "החלטה על אזורים", desc: "אומרים לכם מה מכוסה היום, מה חסר, וכמה עולה כל אזור בנפרד. אתם בוחרים.", duration: "5 דק׳" },
  { title: "מעבר חיווט דרך המחיצה", desc: "מעבר מסודר ומוגן בין תא הנהג לתא המטען. השלב שמאריך עבודה ברכב מסחרי.", duration: "20-40 דק׳" },
  { title: "חיישנים ומתגים", desc: "חיישן נפח בתא המטען, מתגי דלת אחורית והזזה, ומתג לארגז חיצוני אם ביקשתם.", duration: "25-50 דק׳" },
...
export function getVisualSections(slug: string): VisualSection[] {
  ...
  if (slug === 'קודן-לרכב-בראש-העין') {
    return [
      ...
      { type: 'process',  heading: 'חמישה שלבים בהתקנה ברכב עבודה', data: rhaProcess },
      { type: 'stats',    data: keyStats },
    ];
  }
  ...
  if (slug === 'שכפול-מפתח-לרכב-בקריית-מוצקין') {
    return [
      { type: 'features', heading: 'ארבעה מצבי בעלות ומה נדרש בכל אחד', sub: 'ומתי אנחנו לא מבצעים את העבודה בכלל', data: { cards: kmOwnerCards, cols: 3 as 3 } },
      { type: 'process',  heading: 'מהשיחה ועד ההתנעה: סדר הפעולות', data: kmProcess },
      { type: 'stats',    data: keyStats },
    ];
  }
  ...
  if (slug === 'שכפול-מפתח-לרכב-בגני-תקווה') {
    return [
      { type: 'features', heading: 'למחוק את המפתח האבוד או רק להוסיף חדש', sub: 'שישה שיקולים שקובעים את התשובה ואת המחיר', data: { cards: gtEraseCards, cols: 3 as 3 } },
      { type: 'process',  heading: 'איך נראית קריאה בגני תקווה', data: gtProcess },
      { type: 'stats',    data: keyStats },
    ];
  }

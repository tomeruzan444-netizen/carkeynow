...
export const keyDupProcess: Step[] = [
  ...
  { title: 'תכנות השבב', desc: 'מחשב האימוביליזר של הרכב מקבל את קוד השבב החדש בתהליך תכנות ייחודי לדגם.', duration: '10-30 דק׳' },
  { title: 'תכנות השלט', desc: 'השלט מסונכרן עם מחשב הרכב ורולינג-קוד מוגדר למניעת שכפול לא מורשה.', duration: '5 דק׳' },
...
export const keyTypes: FeatCard[] = [
  { icon: '🔑', title: 'מפתח מכאני', desc: 'מפתח פיזי ללא אלקטרוניקה. הנפוץ ברכבים לפני 2000. חיתוך פשוט ומהיר תוך 10 דקות.' },
  { icon: '📡', title: 'מפתח טרנספונדר', desc: 'שבב אלקטרוני מוטמע במפתח מתקשר עם האימוביליזר. רוב הרכבים מ-2000 ואילך.' },
  { icon: '🔄', title: 'מפתח הפוך (Flip)', desc: 'שילוב של מפתח פיזי ושלט בגוף אחד מתקפל. נפוץ בפולקסווגן, אאודי, סקודה ועוד.' },
  { icon: '📲', title: 'Smart Key', desc: 'כניסה וגם הצתה ללא הכנסת מפתח. תקשורת Keyless Entry/Go. דורש ציוד תכנות מתקדם.' },
  { icon: '💎', title: 'מפתח Proximity', desc: 'מפתח קרבה — הרכב מזהה אתכם כשמתקרבים. נפוץ בלקסוס, BMW, מרצדס חדשים.' },
  { icon: '🏍️', title: 'מפתח אופנוע', desc: 'מפתחות לאופנועים — עם ובלי אימוביליזר. מטפלים בכל המותגים הנפוצים בישראל.' },
];
...
export const switchProcess: Step[] = [
  ...
  { title: 'תכנות מחדש', desc: 'ברכבים עם אימוביליזר — מתכנתים את הסוויץ החדש למפתח הקיים. לא צריך מפתח חדש.', duration: '15 דק׳' },
...
export const switchSigns: FeatCard[] = [
  { icon: '🔧', title: 'קושי בהכנסת המפתח', desc: 'צריך לדחוף חזק, להרים את ההגה או לנסות כמה פעמים. זה הסימן הראשון.' },
  { icon: '⚡', title: 'ניסיונות הצתה חוזרים', desc: 'המפתח מסתובב אבל הרכב לא נדלק בפעם הראשונה. לפעמים דורש 3–4 ניסיונות.' },
  { icon: '🔒', title: 'מפתח לא משתחרר', desc: 'אחרי כיבוי — המפתח לא יוצא מהסוויץ. דורש לחיצות ומאמץ יתר.' },
  { icon: '🚗', title: 'עמוד ההגה נועל', desc: 'ההגה נועל ולא מאפשר הצתה. נפוץ כשמסיבים את ההגה בזמן כיבוי.' },
  { icon: '💡', title: 'נורות לא נדלקות', desc: 'לוח המחוונים לא מדליק כשמסובבים המפתח לא. בעיה חשמלית בסוויץ.' },
  { icon: '🔊', title: 'רעש חריג', desc: 'קליק, חריקה או רעש לא רגיל מאזור עמוד ההגה בזמן פתיחת/נעילת המנעול.' },
];
...
export const alarmProcess: Step[] = [
  ...
  { title: 'תכנות ושלטים', desc: 'מתכנתים את השלטים, מגדירים קודי אבטחה ובודקים כל פונקציה.', duration: '15 דק׳' },
...
export const lockoutTabs: TabItem[] = [
  ...
  { label: 'פתרון', content: 'אנחנו משתמשים בשלושה כלים עיקריים: כלי לחץ אוויר ליצירת פתח מינימלי, מוטות מקצועיים לשחרור הנועל, ומכשירי תכנות לרכבים חכמים. כל הפעולות מבוצעות ללא שריטות, ללא שבירה, ועם מינימום זמן פתיחה.' },
...
export const lockoutEquipment: FeatCard[] = [
  { icon: '💨', title: 'כלי לחץ אוויר', desc: 'יוצר פתח של מילימטרים בין הדלת והמסגרת — מאפשר הכנסת מוט ללא שריטה.' },
  { icon: '🔩', title: 'מוטות מקצועיים', desc: 'סדרה של מוטות בצורות שונות לשחרור נועלים ולחצנים פנימיים מכל זווית.' },
  { icon: '💻', title: 'מכשיר תכנות OBD', desc: 'לרכבים חכמים עם Keyless — שחרור הנועל דרך מחשב הרכב ישירות.' },
  { icon: '🛡️', title: 'ציוד הגנה', desc: 'פדים גומי ובד מגן למניעת שריטות על הרכב בזמן הפתיחה.' },
];
...
export const remoteFeatures: FeatCard[] = [
  { icon: '🔐', title: 'Rolling Code', desc: 'כל לחיצה שולחת קוד שונה. אי אפשר ללכוד ולשכפל — אבטחה אמיתית.' },
  { icon: '📶', title: 'טווח 30 מטר', desc: 'שלט איכותי עובד עד 30 מטר. אם הטווח קצר יותר — סימן שיש בעיה טכנית.' },
  { icon: '🔋', title: 'חיסכון בסוללה', desc: 'שלט תקין אמור להחזיק 1–2 שנים. שלט שמרוקן סוללות מהר — יש בו תקלה.' },
  { icon: '🚗', title: 'תואם לכל הדגמים', desc: 'יש לנו שלטים חלופיים ומקוריים לכל הדגמים הנמכרים בישראל.' },
];
...
export const lostKeyTabs: TabItem[] = [
  ...
  { label: 'אתגר', content: 'מפתח אבוד הוא לא רק פתיחת הרכב — זה ייצור מפתח חדש לגמרי, תכנות שבב חדש, ולעיתים נטרול המפתח האבוד כדי שאף אחד לא יוכל להשתמש בו. כל זה דורש ציוד מקצועי ספציפי לדגם.' },
...
export const motoFeatures: FeatCard[] = [
  { icon: '🏍️', title: 'כל מותגי האופנועים', desc: 'הונדה, יאמהה, קוואסאקי, סוזוקי, BMW, פיאג׳ו, KTM — כולם.' },
  { icon: '🔑', title: 'מפתח מכאני + אימוביליזר', desc: 'מפתחות פשוטים עד מפתחות חכמים עם שבב — טיפול בכולם.' },
  { icon: '🔓', title: 'פריצת כיסא', desc: 'פותחים את תא האחסון ללא נזק לפלסטיק או לצבע.' },
  { icon: '⚡', title: 'הגעה לשטח', desc: 'מגיעים אליכם בכל מקום — חניה, דרך, אזור תעשייה.' },
];
...
export const cityKeyProcess: Step[] = [
  ...
  { title: 'אבחון והכנה', desc: 'מזהים את סוג המפתח, מכינים את הלהב וציוד התכנות המתאים לדגם הספציפי.', duration: '5 דק׳' },
  { title: 'עבודה בשטח', desc: 'חיתוך ותכנות המפתח ישירות ליד הרכב שלכם, ללא צורך בגרירה לשום מקום.', duration: '15–50 דק׳' },

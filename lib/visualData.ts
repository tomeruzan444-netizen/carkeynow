...
export const keyTypes: FeatCard[] = [
  ...
  { title: 'Smart Key', desc: 'כניסה וגם הצתה ללא הכנסת מפתח. תקשורת Keyless Entry/Go. דורש ציוד תכנות מתקדם.' },
...
export const lockoutEquipment: FeatCard[] = [
  ...
  { title: 'מכשיר תכנות OBD', desc: 'לרכבים חכמים עם Keyless — שחרור הנועל דרך מחשב הרכב ישירות.' },

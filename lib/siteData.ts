...
export const NAV_CITIES = [
  ...
  { label: 'שכפול מפתח לרכב בפרדס חנה כרכור', href: '/שכפול-מפתח-לרכב-בפרדס-חנה-כרכור' },
  { label: 'שכפול מפתח לרכב בגני תקווה',   href: '/שכפול-מפתח-לרכב-בגני-תקווה' },
  { label: 'שכפול מפתח לרכב בטירת הכרמל', href: '/שכפול-מפתח-לרכב-בטירת-הכרמל' },
  { label: 'שכפול מפתח לרכב בקריית מוצקין', href: '/שכפול-מפתח-לרכב-בקריית-מוצקין' },
  { label: 'שכפול מפתח לרכב בבית שמש',   href: '/שכפול-מפתח-לרכב-בבית-שמש' },
...
export const NAV_BRANDS = [
  ...
  { label: 'שכפול מפתחות לרכב סקייוול',   href: '/שכפול-מפתח-לסקייוול' },
